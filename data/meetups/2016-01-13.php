...
$meetup->setId(0)
    ->setFromDate(new DateTime('2016-01-13 19:00'))
    ->setToDate(new DateTime('2016-01-13 23:00'))
    ...
    ->setTalkingPoints(array(
    	new TalkEntity('Christopher Hoult', 'choult', 'Simple Machine Learning', $abstract),
