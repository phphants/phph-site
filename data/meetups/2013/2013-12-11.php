...
$meetup->setId(0)
    ->setFromDate(new DateTimeImmutable('2013-12-11 19:00'))
    ->setToDate(new DateTimeImmutable('2013-12-11 23:00'))
    ...
    ->setTalkingPoints(array(
        new Talk('Phil Bennett', 'phil_bennett', 'How to develop your development of being a developer without doing any developing', 'A light hearted look at being less shit, covering the periphery skills required including communication, delivery and not being a berk.'),
        new Talk('Gareth Evans', 'garoevans', 'PHP and Enums', 'This talk should begin with a very general introduction to Enums. What is an
