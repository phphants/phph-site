...
$etitle = 'PHP Hampshire - November Meetup';
$eid = '8752752719';
...
$meetup->setId(0)
    ->setFromDate(new DateTimeImmutable('2013-11-13 19:00'))
    ->setToDate(new DateTimeImmutable('2013-11-13 23:00'))
    ...
    ->setTalkingPoints(array(
        new Talk('Rob Davis', 'therobyouknow', 'Building sites with Drupal, its \'Lego\'-like modules and Vagrant for general web development'),
        new Talk('Herb Miller', 'herb_miller', 'Probably doing it wrong.'),
