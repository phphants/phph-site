...
$meetup->setId(0)
    ->setFromDate(new DateTime('2016-11-09 19:00'))
    ->setToDate(new DateTime('2016-11-09 23:00'))
    ...
    ->setTalkingPoints(array(
        new TalkEntity('Wade Urry', 'iWader', '5 minute lightning talk'),
        new TalkEntity('Nick Whitelegg', '', 'EPHP: A tool to help students learn the very basics of PHP', nl2br($abstract)),
    ...
    ->setSchedule(array(
        ...
        new ScheduleEntity(new \DateTime('19:30'), 'Wade Urry'),
        new ScheduleEntity(new \DateTime('19:40'), 'Nick Whitelegg'),
