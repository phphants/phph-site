...
$etitle = 'PHP Hampshire - March 2016 Meetup';
$eid = '20412914577';
...
$abstract = <<<END
In a world of open source software, how we treat and work with people we don't know is important. This talk will cover some lessons I've learned, and hopefully encourage people to get involved.
END;

$meetup->setId(0)
    ->setFromDate(new DateTimeImmutable('2016-03-09 19:00'))
    ->setToDate(new DateTimeImmutable('2016-03-09 23:00'))
    ...
    ->setTalkingPoints(array(
    	new Talk('Pete Heslop', 'Pwheslop', '5 minute lightning talk'),
    	new Talk('David Yell', 'YellDavid', 'Being an Open Source citizen', $abstract),
	...
	->setSchedule(array(
		...
		new Schedule(new \DateTimeImmutable('19:30'), 'Pete Heslop'),
		new Schedule(new \DateTimeImmutable('19:40'), 'David Yell'),
