...
$meetup->setId(0)
    ->setFromDate(new DateTime('2014-01-08 19:00'))
    ->setToDate(new DateTime('2014-01-08 23:00'))
    ...
    ->setTalkingPoints(array(
        new TalkEntity('Michael Cullum', 'michaelcullumuk', 'Why Open Source is good for you (and your organisation)'),
