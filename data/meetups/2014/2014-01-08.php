...
$meetup->setId(0)
    ->setFromDate(new DateTimeImmutable('2014-01-08 19:00'))
    ->setToDate(new DateTimeImmutable('2014-01-08 23:00'))
    ...
    ->setTalkingPoints(array(
        new Talk('Michael Cullum', 'michaelcullumuk', 'Why Open Source is good for you (and your organisation)'),
