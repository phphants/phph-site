...
$meetup->setId(0)
    ->setFromDate(new DateTimeImmutable('2015-08-12 19:00'))
    ->setToDate(new DateTimeImmutable('2015-08-12 23:00'))
    ...
    ->setTalkingPoints(array(
    	new Talk('Steve Winter', 'SteveWinterNZ', 'PHP application monitoring with New Relic', $abstract),
