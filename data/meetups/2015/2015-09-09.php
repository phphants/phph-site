...
$meetup->setId(0)
    ->setFromDate(new DateTimeImmutable('2015-09-09 19:00'))
    ->setToDate(new DateTimeImmutable('2015-09-09 23:00'))
    ...
    ->setTalkingPoints(array(
    	new Talk('Rob Allen', 'akrabat', 'Secure your web application with two-factor authentication', $abstract),
	...
	->setSchedule(array(
		...
		new Schedule(new \DateTimeImmutable('19:30'), 'Rob Allen - Secure your web application with two-factor authentication'),
		new Schedule(new \DateTimeImmutable('20:30'), 'Closing comments'),
		new Schedule(new \DateTimeImmutable('20:45'), 'Social gathering at <del title="Brewhouse is temporarily closed :("><a href="http://brewhouseandkitchen.com/portsmouth">Brewhouse Pompey</a> (The White Swan)</del> <a href="http://www.jdwetherspoon.co.uk/home/pubs/the-trafalgar">The Trafalgar</a> (Wetherspoons)'),
	))
