...
$etitle = 'PHP Hampshire - July 2015 Meetup';
$eid = '16782990376';
...
$meetup->setId(0)
    ->setFromDate(new DateTimeImmutable('2015-07-08 19:00'))
    ->setToDate(new DateTimeImmutable('2015-07-08 23:00'))
    ...
    ->setTalkingPoints(array(
    	new Talk('Ellie Zheleva', 'elizheleva', 'Why should developers care about SEO?', $abstract),
