...
$etitle = 'PHP Hampshire - January 2015 Meetup';
$eid = '15030194717';
...
$meetup->setId(0)
    ->setFromDate(new DateTimeImmutable('2015-01-14 19:00'))
    ->setToDate(new DateTimeImmutable('2015-01-14 23:00'))
    ...
    ->setTalkingPoints(array(
    	new Talk('Adam Nagy', 'AdamTheNagy', 'Make the Web 3D', $abstract),
