...
$etitle = 'PHP Hampshire - March 2015 Meetup';
$eid = '15726854445';
...
$abstract = <<<END
Whether you're creating a complex web application or a simple library, everything you create has a user. Why, then, do we concentrate on our users when developing a user interface, but so often forget them when developing APIs?
END;

$meetup->setId(0)
    ->setFromDate(new DateTimeImmutable('2015-03-11 19:00'))
    ->setToDate(new DateTimeImmutable('2015-03-11 23:00'))
    ...
    ->setTalkingPoints(array(
    	new Talk('Chris Hoult', 'choult', 'Your API is a UI', $abstract),
